...
class _AddEventScreenState extends State<AddEventScreen> {
  ...
  void _handleSaveEvent() async {
    ...
    Navigator.pop(context, 'refresh'); // Pass refresh signal
  }
...
class _EventsListScreenState extends State<EventsListScreen> {
  ...
  List<Event> _events = [
    Event(
      ...
      sportType: 'Football',
      description: 'Inter-college football championship with teams from 8 different colleges competing for the trophy.',
      status: EventStatus.upcoming,
    ),
    Event(
      id: '2',
      name: 'Cricket Skills Assessment',
      date: DateTime.now().add(const Duration(days: 2)),
      time: const TimeOfDay(hour: 14, minute: 30),
      location: 'Cricket Academy, Indoor Nets',
      sportType: 'Cricket',
      description: 'Comprehensive cricket skills evaluation including batting, bowling, and fielding assessments.',
      status: EventStatus.upcoming,
    ),
    Event(
      id: '3',
      ...
      sportType: 'Athletics',
      description: 'Regional athletics competition featuring 100m, 200m, long jump, and shot put events.',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Icon(Icons.location_on, size: 16, color: const Color(0xFF6B7280)),
              const SizedBox(width: 4),
              Expanded(
                child: Text(
                  event.location,
