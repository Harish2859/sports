    ...
    if (courseId == '3') { // Strength Assessment
      return [
        CourseSectionData(
          ...
          description: 'Complete fitness evaluation across all physical qualities',
          units: [
            UnitData(
              id: '1',
              name: 'Height Measurement',
              description: 'Basic anthropometric measurement',
              objectives: ['Record accurate height measurement'],
              dos: ['Stand straight', 'Remove shoes', 'Look forward'],
              donts: ['Don\'t slouch', 'Don\'t wear thick clothing'],
            ),
            UnitData(
              id: '2',
              name: 'Weight Measurement',
              description: 'Basic body weight assessment',
              objectives: ['Record accurate weight measurement'],
              dos: ['Use calibrated scale', 'Minimal clothing', 'Stand still'],
              donts: ['Don\'t hold objects', 'Don\'t move during measurement'],
            ),
            UnitData(
              id: '3',
              name: 'Sit and Reach Test',
              description: 'Flexibility assessment for hamstrings and lower back',
              objectives: ['Measure flexibility range', 'Maintain proper form'],
              dos: ['Warm up first', 'Reach slowly', 'Hold position'],
              donts: ['Don\'t bounce', 'Don\'t force the stretch', 'Don\'t bend knees'],
            ),
            UnitData(
              id: '4',
              name: 'Standing Vertical Jump',
              description: 'Lower body explosive strength assessment',
              objectives: ['Maximum vertical jump height', 'Proper takeoff technique'],
              dos: ['Use arm swing', 'Land safely', 'Give maximum effort'],
              donts: ['Don\'t step forward', 'Don\'t land stiff-legged'],
            ),
            UnitData(
              id: '5',
              name: 'Standing Broad Jump',
              description: 'Lower body explosive strength and power assessment',
              objectives: ['Maximum horizontal distance', 'Controlled landing'],
              dos: ['Use full body coordination', 'Land with both feet', 'Measure from takeoff line'],
              donts: ['Don\'t step over line', 'Don\'t fall backward on landing'],
            ),
            UnitData(
              id: '6',
              name: 'Medicine Ball Throw',
              description: 'Upper body strength and power assessment',
              objectives: ['Maximum throwing distance', 'Proper throwing technique'],
              dos: ['Use overhead technique', 'Follow through', 'Stay behind line'],
              donts: ['Don\'t step over line', 'Don\'t use underhand throw'],
            ),
            UnitData(
              id: '7',
              name: '30m Standing Start Sprint',
              description: 'Speed and acceleration assessment',
              objectives: ['Fastest time possible', 'Proper start technique'],
              dos: ['Start on command', 'Run through finish', 'Maintain form'],
              donts: ['Don\'t false start', 'Don\'t slow down before finish'],
            ),
            UnitData(
              id: '8',
              name: '4 x 10m Shuttle Run',
              description: 'Agility and change of direction assessment',
              objectives: ['Complete course accurately', 'Minimize time'],
              dos: ['Touch each line', 'Change direction quickly', 'Stay low'],
              donts: ['Don\'t miss lines', 'Don\'t take wide turns'],
            ),
            UnitData(
              id: '9',
              name: 'Sit-Ups Test',
              description: 'Core strength and muscular endurance assessment',
              objectives: ['Maximum repetitions in time limit', 'Proper form throughout'],
              dos: ['Full range of motion', 'Controlled movement', 'Breathe regularly'],
              donts: ['Don\'t use momentum', 'Don\'t pull on neck', 'Don\'t arch back'],
            ),
            UnitData(
              id: '10',
              name: 'Endurance Run Test',
              description: 'Cardiovascular endurance assessment (800m for U-12, 1.6km for 12+)',
              objectives: ['Complete distance', 'Maintain steady pace'],
              dos: ['Pace yourself', 'Breathe rhythmically', 'Stay hydrated'],
              donts: ['Don\'t start too fast', 'Don\'t stop unless necessary'],
            ),
          ],
        ),
      ];
